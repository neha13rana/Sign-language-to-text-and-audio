...
class Application:
    def __init__(self):
        ...
        self.T.config(text = "Sign Language to Text",font=("Georgia",20,"bold"))
        ...
        # self.T4.config(text = "Suggestions",fg="red",font = ("Georgia",40,"bold"))

        # self.btcall = tk.Button(self.root,command = self.action_call,height = 0,width = 0)
        # self.btcall.config(text = "About",font = ("Georgia",14))
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            # if(len(predicts) > 0):
            #     self.bt1.config(text=predicts[0],font = ("Georgia",20))
            # else:
            #     self.bt1.config(text="")
            # if(len(predicts) > 1):
            #     self.bt2.config(text=predicts[1],font = ("Georgia",20))
            # else:
            #     self.bt2.config(text="")
            # if(len(predicts) > 2):
            #     self.bt3.config(text=predicts[2],font = ("Georgia",20))
            # else:
            #     self.bt3.config(text="")
            # if(len(predicts) > 3):
            #     self.bt4.config(text=predicts[3],font = ("Georgia",20))
            # else:
            #     self.bt4.config(text="")
            # if(len(predicts) > 4):
            #     self.bt4.config(text=predicts[4],font = ("Georgia",20))
            # else:
            #     self.bt4.config(text="")                
    ...
    #     self.tx.config(text = "Efforts By", fg="red", font = ("Georgia",30,"bold"))
    ...
    #     self.tx6.config(text = "RC\nIIT2016141", font = ("Georgia",15,"bold"))
    ...
    #     self.tx2.config(text = "Nitin\nIIT2016132", font = ("Georgia",15,"bold"))
    ...
    #     self.tx3.config(text = "Luv\nIIT2016085", font = ("Georgia",15,"bold"))
    ...
    #     self.tx4.config(text = "Sheldon\nIIT2016137", font = ("Georgia",15,"bold"))
    ...
    #     self.tx5.config(text = "Siddhant\nIIT2016069", font = ("Georgia",15,"bold"))
        
    #     self.tx7 = tk.Label(self.root1)
    #     self.tx7.place(x = 170,y = 360)
    #     self.tx7.config(text = "Under the supervision of", fg="red", font = ("Georgia",30,"bold"))
    ...
    #     self.tx6.config(text = "Dr. Vrijendra Singh", font = ("Georgia",30,"bold"))
